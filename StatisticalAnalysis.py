...
class Stats():
    ...
    def __init__(self, path, statsPath):
        self.path = path
    ...
    def Association_Rule_Learning(self, data, min_support = 0.00045, min_confidence = 0.02, min_items = 2, max_items = 5, rhs = 'none'):
        ''' 
        ...
        currPath = self.statsPath + 'Apriori/'
        ...
        self.ARL['resultsDf'] = ARLRules
        return ARLRules


    def Mediation_Analysis(self, data, dep, mediator, indep, continuous = list()):
        '''
    ...
    def Mendelian_Ranomization(self, data, dep, indep, inst, control = list()):
        '''
    ...
    def Multivariate_Reg(self, data, target, continuous, categorical, correct = False, cutoff = 10, stepwise = True, VIF = True):
    ...
    def Odds_Ratios(self, data, target, continuous, categorical = list(), correct = False, cutoff = 10, stepwise = True, VIF = True):
    ...
    def ANOVA(self, data, dep, indep, alpha = 0.05, oneWay = True, followUp = False):
        '''
        ...
        if oneWay:
            ...
            return self.twoWay_ANOVA(data, dep, indep, alpha, False, followUp)


    def Association_Analysis(self, data, vars, oneTarget = False, target = '', chi = False, fisher = False):
